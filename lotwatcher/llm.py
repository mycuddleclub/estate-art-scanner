...
A GALLERY line means the artist has commercial gallery representation (a real positive signal a dealer backs the work) — weight by tier: Tier-1 mega-gallery (Gagosian/Zwirner/Hauser & Wirth class) is a strong buy signal, Tier-2 launchpad is a solid signal, Tier-3/4 is a modest plus. A folk/self-taught artist picked up by ANY serious gallery is exactly the discovery Daniel wants. Absence of a GALLERY line is NEUTRAL, never a negative.
...
{{"flag": "YES/NO", "confidence": "HIGH/MEDIUM/LOW", "score": 0-10, "reasoning": "2-3 sentences of FACTS ONLY: artist standing, documented prices, what the lot is, condition/attribution issues. State figures with full numbers (e.g. $12,000). Do NOT address the collector, do NOT say things like \'worth a look\', \'Daniel can research\', \'merits further review\', or any recommendation language. Just the evidence.", "headline": "max 12 words for the email subject line"}}
...
IMPORTANT for CONTEMPORARY artists: a GALLERY line (commercial gallery representation) or an Artsy market presence COUNTS as the artist being genuinely documented/listed — a living artist backed by a real gallery is exactly a name Daniel can build a case on, even if absent from the museum/ULAN reference data (which skews historical). Do not reject a gallery-represented or Artsy-present artist as 'unknown'. Flag NO for: anonymous or undocumented makers even if the piece is old/rare/folk (no name = no case, he does not want these); reproductions and mass-produced prints; decorative mass goods; fairly-priced lots; and speculative "might be something" lots with no identifiable artist. "Old, rare, no bids" is NOT enough — there must be a real, name-able, documented artist behind it.
